...
module.exports.service_reporter = function service_reporter(META){
  // META has fields: NAME, PORT, URL, SERVICES,
  function report(typ, msg){
    var report = META.NAME + ' @'+META.URL+':'+META.PORT+'\n\t';
    switch(typ){
      case "error":
        report += '!!
        break;
